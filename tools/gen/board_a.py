...
BABY = [
    ...
    C("STAGEGOAL", "たっち！", "よちよち あるけた。ようちえんへ いく じゅんびが できた。", pp=2),
]

KINDER = [
    C("GOOD", "ようちえん にゅうえん", "きいろい ぼうしを かぶって はじめての とうえん。", "bg_ceremony_hall", pp=2),
    E("あさの おうた", "ピアノに あわせて うたった。きょうも いつもどおり。"),
    CHOICE("じゆうじかん", "ようちえんの じゆうじかん、なにする？",
    ...
    C("GOOD", "えんそく", "どうぶつを みて おべんとうを たべた。", st=2, pp=2, bg="bg_park_day"),
    C("GOOD", "ゆうえんち", "かんらんしゃの てっぺんから まちを みおろした。", pp=3, mn=-500, bg="bg_amusement_park"),
...
ELEM = [
    ...
    CH("がくげいかい", "げきの しゅやくに りっこうほ！", "pp", 12,
